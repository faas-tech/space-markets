...
//             "Admin missing DEFAULT_ADMIN_ROLE on AssetRegistry"
//         );
//         require(assetRegistry.hasRole(assetRegistry.ADMIN_ROLE(), admin), "Admin missing ADMIN_ROLE on AssetRegistry");
//         require(
//             assetRegistry.hasRole(assetRegistry.REGISTRAR_ROLE(), admin),
//             "Admin missing REGISTRAR_ROLE on AssetRegistry"
//         );

//         // Verify LeaseFactory permissions
//         require(
//             leaseFactory.hasRole(leaseFactory.DEFAULT_ADMIN_ROLE(), admin),
//             "Admin missing DEFAULT_ADMIN_ROLE on LeaseFactory"
//         );
...
//             "Admin missing DEFAULT_ADMIN_ROLE on Marketplace"
//         );
...
//         require(
//             address(leaseFactory.registry()) == address(assetRegistry), "LeaseFactory registry not linked correctly"
//         );
//         require(
//             address(marketplace.leaseFactory()) == address(leaseFactory),
//             "Marketplace lease factory not linked correctly"
//         );
