...
//         // Create sample unstructured metadata
//         string[] memory metadataKeys = new string[](8);
//         string[] memory metadataValues = new string[](8);

//         metadataKeys[0] = "name";
//         metadataValues[0] = "Test Asset";

//         metadataKeys[1] = "description";
//         metadataValues[1] = "A test asset for demonstration purposes";

//         metadataKeys[2] = "image";
//         metadataValues[2] = "https://example.com/asset-image.jpg";

//         metadataKeys[3] = "external_url";
//         metadataValues[3] = "https://example.com/asset-details";

//         metadataKeys[4] = "category";
//         metadataValues[4] = "Test Category";

//         metadataKeys[5] = "location";
//         metadataValues[5] = "Test Location";

//         metadataKeys[6] = "value";
//         metadataValues[6] = "1000000000000000000"; // 1 ETH in wei

//         metadataKeys[7] = "currency";
//         metadataValues[7] = "ETH";
...
//             "https://example.com/asset-uri", // Legacy URI
...
//     /// @notice Test unstructured onchain metadata functionality
//     /// @dev Verifies that unstructured metadata is properly stored and accessible
//     function test_UnstructuredMetadata() public {
//         // ┌─────────────────────────────────────────────────────────────────────┐
//         // │                    VERIFY INITIAL METADATA                        │
//         // │                                                                     │
//         // │ Check that the metadata was properly stored during deployment.     │
//         // └─────────────────────────────────────────────────────────────────────┘

//         Metadata[] memory metadata = token.getMetadata();
//         assertEq(metadata.name, "Test Asset", "Asset name should match");
//         assertEq(
//             metadata.description,
//             "A test asset for demonstration purposes",
//             "Asset description should match"
//         );
//         assertEq(
//             metadata.image,
//             "https://example.com/asset-image.jpg",
//             "Asset image should match"
//         );
//         assertEq(
//             metadata.external_url,
//             "https://example.com/asset-details",
//             "External URL should match"
//         );
//         assertEq(
//             metadata.category,
//             "Test Category",
//             "Asset category should match"
//         );
//         assertEq(
//             metadata.location,
//             "Test Location",
//             "Asset location should match"
//         );
//         assertEq(
//             metadata.value,
//             1000000000000000000,
//             "Asset value should match"
//         );
//         assertEq(metadata.currency, "ETH", "Asset currency should match");
//         assertEq(metadata.attributes.length, 3, "Should have 3 attributes");

//         // ┌─────────────────────────────────────────────────────────────────────┐
//         // │                    VERIFY INDIVIDUAL METADATA FIELDS               │
//         // │                                                                     │
//         // │ Test individual getter functions for metadata fields.             │
//         // └─────────────────────────────────────────────────────────────────────┘

//         assertEq(
//             token.assetName(),
//             "Test Asset",
//             "Asset name getter should work"
//         );
//         assertEq(
//             token.assetDescription(),
//             "A test asset for demonstration purposes",
//             "Asset description getter should work"
//         );
//         assertEq(
//             token.assetImage(),
//             "https://example.com/asset-image.jpg",
//             "Asset image getter should work"
//         );
//         assertEq(
//             token.assetValue(),
//             1000000000000000000,
//             "Asset value getter should work"
//         );
//         assertEq(
//             token.assetCurrency(),
//             "ETH",
//             "Asset currency getter should work"
//         );

//         // ┌─────────────────────────────────────────────────────────────────────┐
//         // │                    VERIFY ATTRIBUTE FUNCTIONALITY                  │
//         // │                                                                     │
//         // │ Test attribute storage and retrieval functionality.                │
//         // └─────────────────────────────────────────────────────────────────────┘

//         assertEq(
//             token.getAttribute("color"),
//             "blue",
//             "Color attribute should be retrievable"
//         );
//         assertEq(
//             token.getAttribute("size"),
//             "large",
//             "Size attribute should be retrievable"
//         );
//         assertEq(
//             token.getAttribute("condition"),
//             "excellent",
//             "Condition attribute should be retrievable"
//         );
//         assertEq(
//             token.getAttribute("nonexistent"),
//             "",
//             "Non-existent attribute should return empty string"
//         );
//     }

//     /// @notice Test metadata update functionality
//     /// @dev Verifies that metadata can be updated by admin
//     function test_MetadataUpdate() public {
//         // ┌─────────────────────────────────────────────────────────────────────┐
//         // │                    UPDATE BASIC METADATA                           │
//         // │                                                                     │
//         // │ Test updating basic metadata fields through the update function.   │
//         // └─────────────────────────────────────────────────────────────────────┘

//         vm.prank(admin);
//         token.updateBasicMetadata(
//             "Updated Asset Name",
//             "Updated asset description",
//             "https://example.com/new-image.jpg",
//             "https://example.com/new-details"
//         );
...
//             token.assetName(),
//             "Updated Asset Name",
//             "Asset name should be updated"
//         );
//         assertEq(
//             token.assetDescription(),
//             "Updated asset description",
//             "Asset description should be updated"
//         );
//         assertEq(
//             token.assetImage(),
//             "https://example.com/new-image.jpg",
//             "Asset image should be updated"
//         );

//         // ┌─────────────────────────────────────────────────────────────────────┐
//         // │                    UPDATE VALUE AND CURRENCY                       │
//         // │                                                                     │
//         // │ Test updating asset value and currency.                            │
//         // └─────────────────────────────────────────────────────────────────────┘

//         vm.prank(admin);
//         token.updateValue(2000000000000000000, "USDC"); // 2 ETH worth in USDC
...
//             token.assetCurrency(),
//             "USDC",
//             "Asset currency should be updated"
//         );
...
//         vm.prank(admin);
//         token.updateLocation("New York, NY");

//         AssetMetadata memory metadata = token.getMetadata();
//         assertEq(
//             metadata.location,
//             "New York, NY",
//             "Asset location should be updated"
//         );
//     }

//     /// @notice Test attribute management
//     /// @dev Verifies that attributes can be added and updated
//     function test_AttributeManagement() public {
//         // ┌─────────────────────────────────────────────────────────────────────┐
//         // │                    ADD NEW ATTRIBUTE                               │
//         // │                                                                     │
//         // │ Test adding a new attribute to the asset.                          │
//         // └─────────────────────────────────────────────────────────────────────┘

//         vm.prank(admin);
//         token.setAttribute("material", "steel", 3); // Add at index 3

//         assertEq(
//             token.getAttribute("material"),
//             "steel",
...
//         vm.prank(admin);
//         token.setAttribute("color", "red", 0); // Update existing color attribute
...
//     /// @notice Test unauthorized metadata updates
//     /// @dev Verifies that only admin can update metadata
//     function test_RevertWhen_UnauthorizedMetadataUpdate() public {
//         // Alice (non-admin) tries to update metadata
//         vm.prank(alice);
//         vm.expectRevert(); // Should fail due to missing admin role
//         token.updateBasicMetadata("Hacked Name", "Hacked Description", "", "");

//         // Bob (non-admin) tries to update value
//         vm.prank(bob);
//         vm.expectRevert(); // Should fail due to missing admin role
//         token.updateValue(0, "HACKED");

//         // Bob (non-admin) tries to set attribute
//         vm.prank(bob);
//         vm.expectRevert(); // Should fail due to missing admin role
//         token.setAttribute("hacked", "value", 0);

//         // Verify metadata is unchanged
//         assertEq(
//             token.assetName(),
//             "Test Asset",
//             "Asset name should remain unchanged"
//         );
//         assertEq(
//             token.assetValue(),
//             1000000000000000000,
...
//             token.getAttribute("color"),
//             "blue",
//             "Color attribute should remain unchanged"
//         );
//     }
...
//             0,
//             "Initial snapshot ID should be 0"
//         );
...
//             token.getCurrentSnapshotId(),
//             1,
//             "Current snapshot ID should be updated to 1"
//         );
//     }
...
//             500e18,
//             "Alice current balance should be 500"
//         );
//         assertEq(
//             token.balanceOf(bob),
//             500e18,
//             "Bob current balance should be 500"
//         );
...
//         assertEq(
//             token.balanceOfAt(alice, snapshotId),
//             700e18,
//             "Alice snapshot balance should be 700 (pre-second transfer)"
//         );
//         assertEq(
//             token.balanceOfAt(bob, snapshotId),
//             300e18,
...
//         );
//         assertEq(
//             token.getVotes(zeroAddr),
//             0,
//             "Zero address should have zero voting power"
//         );
//         assertEq(
//             token.delegates(zeroAddr),
//             zeroAddr,
//             "Zero address delegates to itself"
//         );
...
//         assertEq(
//             token.balanceOfAt(zeroAddr, snapshotId),
//             0,
//             "Zero address historical balance should be zero"
//         );
...
//             token.delegates(alice),
//             bob,
//             "Alice should now delegate to Bob"
//         );
...
//             token.getVotes(alice),
//             0,
//             "Alice should have zero voting power after delegating"
//         );
...
//             token.delegates(alice),
//             alice,
//             "Alice should delegate back to herself"
//         );
//         assertEq(
//             token.getVotes(alice),
//             token.balanceOf(alice),
//             "Alice should regain her voting power"
//         );
//     }
...
//         assertEq(
//             token.balanceOfAt(alice, snapshot1),
//             700e18,
//             "Alice balance at snapshot 1"
//         );
//         assertEq(
//             token.balanceOfAt(bob, snapshot1),
//             300e18,
//             "Bob balance at snapshot 1"
//         );

//         assertEq(
//             token.balanceOfAt(alice, snapshot2),
//             500e18,
//             "Alice balance at snapshot 2"
//         );
//         assertEq(
//             token.balanceOfAt(bob, snapshot2),
//             500e18,
//             "Bob balance at snapshot 2"
//         );
...
//             token.balanceOfAt(alice, snapshot1),
//             700e18,
//             "Alice balance at snapshot 1 unchanged"
//         );
//         assertEq(
//             token.balanceOfAt(bob, snapshot1),
//             300e18,
//             "Bob balance at snapshot 1 unchanged"
//         );
//         assertEq(
//             token.balanceOfAt(alice, snapshot2),
//             500e18,
//             "Alice balance at snapshot 2 unchanged"
//         );
//         assertEq(
//             token.balanceOfAt(bob, snapshot2),
//             500e18,
//             "Bob balance at snapshot 2 unchanged"
//         );
//     }
...
//                 snapshots[i],
//                 i + 1,
//                 "Snapshot ID should increment sequentially"
//             );
//         }
...
//         assertEq(
//             token.balanceOfAt(alice, snapshots[0]),
//             1000e18,
//             "Snapshot 0: Alice balance"
//         );
//         assertEq(
//             token.balanceOfAt(alice, snapshots[1]),
//             950e18,
//             "Snapshot 1: Alice balance"
//         );
//         assertEq(
//             token.balanceOfAt(alice, snapshots[2]),
//             850e18,
//             "Snapshot 2: Alice balance"
//         );
//         assertEq(
//             token.balanceOfAt(alice, snapshots[3]),
//             700e18,
//             "Snapshot 3: Alice balance"
//         );
//         assertEq(
//             token.balanceOfAt(alice, snapshots[4]),
//             500e18,
//             "Snapshot 4: Alice balance"
//         );

//         // Verify total supply remains constant across all snapshots
//         for (uint256 i = 0; i < 5; i++) {
//             assertEq(
//                 token.totalSupplyAt(snapshots[i]),
//                 1000e18,
...
//         assertTrue(
//             token.hasRole(snapshotRole, admin),
//             "Admin should still have snapshot role"
//         );
//         vm.prank(admin);
//         uint256 snapshotId = token.snapshot();
//         assertTrue(
//             snapshotId > 0,
//             "Admin should still be able to create snapshots"
//         );
//     }
...
//             token.balanceOf(alice),
//             aliceBalanceBefore,
//             "Alice balance unchanged after zero transfer"
//         );
//         assertEq(
//             token.balanceOf(bob),
//             bobBalanceBefore,
//             "Bob balance unchanged after zero transfer"
//         );
...
//             token.balanceOf(alice),
//             0,
//             "Alice should have zero balance after transferring all"
//         );
...
//             token.balanceOfAt(alice, snapshot1),
//             1000e18,
//             "Snapshot 1: All tokens with Alice"
//         );
//         assertEq(
//             token.balanceOfAt(alice, snapshot2),
//             500e18,
//             "Snapshot 2: Equal distribution"
//         );
//         assertEq(
//             token.balanceOfAt(alice, snapshot3),
//             0,
//             "Snapshot 3: All tokens with Bob"
//         );

//         assertEq(
//             token.balanceOfAt(bob, snapshot1),
//             0,
//             "Snapshot 1: Bob has no tokens"
//         );
//         assertEq(
//             token.balanceOfAt(bob, snapshot2),
//             500e18,
//             "Snapshot 2: Bob has half"
//         );
//         assertEq(
//             token.balanceOfAt(bob, snapshot3),
//             1000e18,
//             "Snapshot 3: Bob has all tokens"
//         );
//     }
// }
